<template>
	<div class="business-add">
		<el-breadcrumb separator="|" class="header-breadcrumb">
		  	<el-breadcrumb-item :to="{ path: '/broker-company' }" class="go-back"><i class="el-icon-arrow-left"></i>返回</el-breadcrumb-item>
		  	<el-breadcrumb-item class="add-text">添加经纪公司</el-breadcrumb-item>
		</el-breadcrumb>
		<div class="business-info">
			<el-form ref="brokerAddFormData" :label-position="labelPosition" :relus="businessRelus" label-width="120px" :model="brokerAddFormData" class="business-form">
			  	<el-row>
			  		<el-col :span="8">
					  	<el-form-item label="门店名称：" prop="contacts">
			  	...
			  	<el-row>
			  		<el-col :span="8">
					  	<el-form-item label="门店类型：" prop="contacts">
			  				<el-select v-model="brokerAddFormData.provinceValue" placeholder="省">
							    <el-option
							      v-for="item in province"
                  				  :key="item.cityId"
			  		...
			  		<el-col :span="8">
					  	<el-form-item label="合作期开始：" prop="signDate">
					    	<el-date-picker
						      	v-model="brokerAddFormData.signDate"
						      	type="date"
						      	placeholder="请选择签约时间"
						      	:editable="false"
			  	...
			  	<el-row>
			  		<el-col :span="8">
					  	<el-form-item label="上级门店：" prop="contactsPhone">
			  				<el-select v-model="brokerAddFormData.provinceValue" placeholder="省">
							    <el-option
							      v-for="item in province"
                  				  :key="item.cityId"
			  		...
			  		<el-col :span="8">
					  	<el-form-item label="合作期结束：" prop="serviceDate">
					    	<el-date-picker
		                        v-model="value1"
		                        type="date"
		                        placeholder="选择日期"
			  	...
			  	<el-form-item class="text-center mt20">
			    	<el-button @click="resetForm('brokerAddFormData')" class="button-style mr10">取消</el-button>
			    	<el-button type="primary" @click="onSubmit('brokerAddFormData')" class="button-style ml10">保存</el-button>
			  	</el-form-item>
			</el-form>
		</div>
	</div>
